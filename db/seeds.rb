...
domains = [
  ...
  },
  {
    ...
    icon: 'brain',
    level_titles: { 1 => 'Awakening', 2 => 'Aware', 3 => 'Balanced', 4 => 'Grounded', 5 => 'Resilient',
                    6 => 'Thriving' },
    position: 2
  },
  {
    ...
    icon: 'dollar',
    level_titles: { 1 => 'Surviving', 2 => 'Stable', 3 => 'Building', 4 => 'Growing', 5 => 'Prospering',
                    6 => 'Abundant' },
    position: 3
  },
  {
    ...
    icon: 'users',
    level_titles: { 1 => 'Distant', 2 => 'Reaching', 3 => 'Connected', 4 => 'Bonded', 5 => 'Nurturing',
                    6 => 'Pillar' },
    position: 4
  },
  {
  ...
  },
  {
    ...
    icon: 'palette',
    level_titles: { 1 => 'Dabbler', 2 => 'Casual', 3 => 'Committed', 4 => 'Enthusiast', 5 => 'Devoted',
                    6 => 'Virtuoso' },
    position: 6
  },
  {
    ...
    icon: 'compass',
    level_titles: { 1 => 'Homebody', 2 => 'Curious', 3 => 'Explorer', 4 => 'Adventurer', 5 => 'Voyager',
                    6 => 'Legendary' },
    position: 7
  }
]
...
Rails.logger.debug { "Created #{Domain.count} domains" }
